...
?>
<?php foreach ($drm->declaration->getProduitsDetailsByCertificationsForPdf(true,$detailsNodes) as $typeDrmProduit => $produitsDrmByCertifications): ?>
  \begin{large} <?php echo $libelleDetail; ?>  \end{large}
