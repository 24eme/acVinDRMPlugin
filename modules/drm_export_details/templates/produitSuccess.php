<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <form data-related-element="#input_sortie_export_<?php echo $detail->getHashForKey() ?>" class="form-horizontal form-ajax-modal" data-content=".ajax-content" method="post" action="<?php echo url_for('drm_export_details', array('sf_subject' => $detail, 'cat_key' => $catKey, 'key' => $key)) ?>">
